...
class Profile(ndb.Model):
    ...
    sessionKeysWishlist = ndb.IntegerProperty(repeated=True)
...
class Session(ndb.Model):
    ...
    duration_mins = ndb.IntegerProperty()
...
class SessionForm(messages.Message):
    ...
    duration_mins = messages.IntegerField(5)
    type_of_session = messages.EnumField('SessionType', 6)
...
class FeaturedSpeakerForm(messages.Message):
    """FeaturedSpeakerForm -- Feature Speaker outbound form message"""
